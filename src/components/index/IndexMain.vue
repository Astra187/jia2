<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0 0 0 140px","margin":"0","position":"relative","background":"#fafafe","display":"block"} : {"minHeight":"100%","padding":"0","margin":"0 0 0 250px","position":"relative","background":"#F3F5F6","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0px 3px 6px 1px rgba(0,0,0,0.16)","padding":"0px 30px","margin":"0 auto","alignItems":"center","background":"#fff","display":"flex","width":"100%","position":"relative","justifyContent":"flex-end","zIndex":"1","height":"84px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"width":"100%","padding":"12px 10px","margin":"0 auto","borderRadius":"0px","background":"#fff"}' class="bread-crumbs"></bread-crumbs>
