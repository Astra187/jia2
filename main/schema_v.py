...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": "成功", "data": []}
        # Linux
        # cmd = "cd /yykj/python/9999/spiderz08f2567 && D:\\biyesheji\\python37\\Scripts\\scrapy.exe crawl "+tableName+"Spider -a databaseName=tingge1eg9z2w5"
        # Windows
        cmd = "cd D:\\biyesheji\\spider && D:\\biyesheji\\python37\\Scripts\\scrapy.exe crawl " + tableName + "Spider -a databaseName=tingge1eg9z2w5"
        os.system(cmd)
